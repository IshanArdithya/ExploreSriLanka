...
<body>
    <div class="container">
        <div class="pic1">
            ...
            <h1>Hello {{user_name}},<br>Thank you for your recent transaction.</h1>
            <h2>Order Details:</h2>
            <h5><br>- Order ID: {{order_id}}<br>
                <br>- Name: {{full_name}}<br>
                <br>- Ordered Items:<br> {{order_items}}<br>
                <br>- Total Price: LKR {{total_price}}<br>
                <br>
            </h5>
            <h3>
