...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
  ...
  $sql = "SELECT MAX(RIGHT(customer_id, 5)) AS max_id FROM hotels";
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    try {
      ...
      $sql = "INSERT INTO hotels (email, password, first_name, last_name, contact_number, nationality, email_verified_at, customer_id) VALUES ('$email', '$password', '$first_name', '$last_name', '$contact_number', '$nationality', NULL, '$customer_id')";
      $result = mysqli_query($conn, $sql);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["verify_email"])) {
  ...
  $sql = "UPDATE hotels SET email_verified_at = NOW(), verification_code = NULL WHERE email = '" . $email . "' AND verification_code = '" . $verification_code . "'";
  $result = mysqli_query($conn, $sql);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["send_code"])) {
  ...
  $sql = "UPDATE hotels SET verification_code = '$verification_code' WHERE email = '$email'";
  $result = mysqli_query($conn, $sql);
